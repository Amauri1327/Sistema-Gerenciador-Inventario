...
INSERT INTO tb_product (name, description, quantity, category, max_Stock, min_Stock, supplier_id) VALUES ('Galaxy M35', 'Smartphone Samsung vendido online', 3, 'Eletronicos', 10, 1, 2);
INSERT INTO tb_product (name, description, quantity, category, max_Stock, min_Stock, supplier_id) VALUES ('iPhone 14', 'Smartphone Apple com câmera avançada', 5, 'Eletronicos', 15, 2, 2);
INSERT INTO tb_product (name, description, quantity, category, max_Stock, min_Stock, supplier_id) VALUES ('Dell XPS 13', 'Notebook ultrafino com tela infinita', 8, 'Computadores', 20, 3, 2);
INSERT INTO tb_product (name, description, quantity, category, max_Stock, min_Stock, supplier_id) VALUES ('Sony WH-1000XM4', 'Fone de ouvido com cancelamento de ruído', 12, 'Acessorios', 25, 5, 1);
INSERT INTO tb_product (name, description, quantity, category, max_Stock, min_Stock, supplier_id) VALUES ('Detergente Arial', 'Lavagem de pratos', 6, 'Limpeza', 20, 3, 1);
